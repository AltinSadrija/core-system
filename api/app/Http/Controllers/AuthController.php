...
class AuthController extends Controller
{
    ...
    public function usersData(Request $request)
    {
        ...
        $usersCollection = new Collection($all_users);

// Paginate the collection with 10 users per page
        $perPage = $request->perPage;
        $currentPage = $request->page; // Get the current page from the request, default to 1 if not specified

// Create a Paginator instance manually
        $paginatedUsers = new Paginator(
...
// Return a JSON response
        return response()->json([
            'users' => (object) ($paginatedUsers),
            'total' => $usersCollection->count(),
            'length' => count($paginatedUsers),
        ]);
